...
def test_get_all_possts(authorized_client, test_posts):
...
def test_get_one_post_not_exist(authorized_client, test_posts):
    res = authorized_client.get(f"/posts/80000")
...
@pytest.mark.parametrize("title, content, published", [
    ...
    ("Favorite Pizza title", "I love pepperoni", False),
    ("tallest skyscrapers", "hige", True),
])
